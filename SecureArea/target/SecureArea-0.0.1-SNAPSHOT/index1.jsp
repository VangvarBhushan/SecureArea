                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-16 mb-4">
                        ...
                        <div class="view overlay z-depth-1-half">
                            <img src="images1/kirtee.JPG" class="img-fluid" alt="" width="200px" height="500px">
                            <div class="mask rgba-white-slight"></div>
                        </div>

                        <h4 class="my-4 font-weight-bold">Kirtee Kadu Fegade(TL)</h4>
                        <p class="grey-text">fegadekirtee@gmail.com</p>
                    ...
                    <div class="col-lg-6 col-md-6 mb-4">
                        ...
                        <div class="view overlay z-depth-1-half">
                            <img src="images1/ankita.jpg" class="img-fluid" alt="" width="200px" height="500px">
                            <div class="mask rgba-white-slight"></div>
                        </div>

                        <h4 class="my-4 font-weight-bold">Ankita Ajay Patil</h4>
                        <p class="grey-text">123ankitaajay@gmail.com</p>
                    ...
                    <div class="col-lg-6 col-md-6 mb-4">
                        ...
                        <div class="view overlay z-depth-1-half">
                            <img src="images1/Rutuja.jpg" class="img-fluid" alt="" width="200px" height="500px">
                            <div class="mask rgba-white-slight"></div>
                        </div>

                        <h4 class="my-4 font-weight-bold">Rutuja Rajendra Mane</h4>
                        <p class="grey-text">rutujamane1997@gmail.com</p>
                    ...
                    <div class="col-lg-6 col-md-12 mb-4">
                        ...
                        <div class="view overlay z-depth-1-half">
                            <img src="images1/Pallavi.jpeg" class="img-fluid" alt="" width="200px" height="500px">
                            <div class="mask rgba-white-slight"></div>
                        </div>

                        <h4 class="my-4 font-weight-bold">Pallavi Bhausaheb Chaudhari</h4>
                        <p class="grey-text">pallavichaudhari033@gmail.com</p>
    ...
    <div class="footer-left" data-equalizer-watch>
      <div class="baseline">
        <div class="contact-details">
          ...
          <p><i class="glyphicon glyphicon-phone" aria-hidden="true"></i><span>+91-7709561446</span></p>
         
          <p><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i><span>Pune-411017</span></p>
            <p><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i>fegadekirtee@gmail.com</p>
       		 </div>
       		 </div>
        	</div>
        </footer>
